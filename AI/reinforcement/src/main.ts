...
//נרמול נתוני בסיס
/*
מפני שאי אפשר ליצור רשמת נוירונים שמקבלת טקסט ומחזירה מספר
צריך לנרמל את הנתונים כך שהקלט והפלט יהיו אותו דבר. 
על מנת לקצר את תהליך הלמידה ולייעל אותו נמיר הכל למספרים
*/
